...
import { ENCAPSULATED_PDF_REPORT_SOP_CLASS_UID } from './searchEncapsulatedPdfReports.js';

/**
 * Fetches an Encapsulated PDF instance's metadata from the DICOMweb server and converts it to a human-readable text format.
 * @method
 * @param {string} studyInstanceUid - The Study Instance UID of the PDF instance.
 * @param {string} seriesInstanceUid - The Series Instance UID of the PDF instance.
 * @param {string} sopInstanceUid - The SOP Instance UID of the PDF instance.
 ...
 * @returns {Promise<string>} The human-readable text representation of the Encapsulated PDF.
 * @throws {Error} If the HTTP response status is not in the 2xx range or if the instance is not found.
 * @example
 * const text = await getEncapsulatedPdfReportText('1.2.840.113619.2.55.3.604688123.123.1591781234.467', '1.2.840.113619.2.55.3.604688123.123.1591781234.468', '1.2.840.113619.2.55.3.604688123.123.1591781234.469');
 */
